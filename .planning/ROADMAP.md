...
- [ ] **Phase 25: cloud-claude CLI 骨架与连接** — Go 二进制 cloud-claude 的配置、认证和远端容器连接闭环（1 plan）
...
**Plans**: 1 plan
Plans:
- [ ] 25-01-PLAN.md — cloud-claude 配置/init、Entry 认证与 SSH+PTY 闭环
...
| 25. cloud-claude CLI 骨架与连接 | 0/1 | Not started | - |
