...
Reference full template: `/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.claude/get-shit-done/templates/state.md`.
