...
<required_reading>
Read `/Users/zaneliu/Projects/open-source/cloud-cli-proxy/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
